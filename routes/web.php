...
Route::middleware('auth')->group(function () {
    ...
    // Case chat endpoints for real-time conversation and attachments.
    Route::get('/case/{caseFile}/chat/messages', [CaseChatController::class, 'index'])->name('cases.chat.index');
    Route::post('/case/{caseFile}/chat/messages', [CaseChatController::class, 'store'])->name('cases.chat.store');
    Route::delete('/case/{caseFile}/chat/messages/{chatMessage}', [CaseChatController::class, 'destroy'])->name('cases.chat.destroy');
    Route::get('/case/{caseFile}/chat/unread', [CaseChatController::class, 'unread'])->name('cases.chat.unread');
    Route::get('/case/{caseFile}/chat/attachments/{chatMessage}', [CaseChatController::class, 'download'])->name('cases.chat.download');
